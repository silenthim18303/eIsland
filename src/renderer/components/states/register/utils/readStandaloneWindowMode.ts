 ...
 * @description 读取独立窗口模式配置
 * @author 鸡哥
 */

import { STANDALONE_WINDOW_MODE_STORE_KEY, LEGACY_COUNTDOWN_WINDOW_MODE_STORE_KEY } from '../config/registerConstants';

/**
 * 从 store 读取当前窗口模式（集成 / 独立）。
 * @returns 窗口模式。
 */
