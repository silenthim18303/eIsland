...
export default sidebar({
  ...
  "/api-backend/": [
    ...
    {
      text: "Server Mini Game",
      icon: "gamepad",
      collapsible: true,
      children: [
        "server-mini-game/README.md",
        "server-mini-game/mini-game-score-api/README.md",
      ],
    },
    {
      text: "Server Service Status",
      icon: "activity",
      collapsible: true,
      children: [
        "server-service-status/README.md",
